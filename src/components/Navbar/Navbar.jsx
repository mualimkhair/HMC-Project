...
const Navbar = () => {
  return (
    <div className="font-mons flex flex-wrap bg-black py-4 px-2 justify-between shadow-primary shadow-sm z-50 sticky top-0 w-full">
      ...
      <div className="flex font-mons flex-wrap justify-between ">
        ...
        <div className="grid md:grid-cols-3 md:gap-4 md:w-32">
          <Link to={`../../Cart`} className="bg-white rounded-full w-10 h-full text-bg justify-items-center content-center">
            <ShoppingCart size={24} className="text-secondary" />
          </Link>
          <button className="bg-white rounded-full w-10 h-full text-bg justify-items-center hidden md:block">
