...
const Footer = () => {
  return (
    <div class="text-center mt-40 mb-4">
      <Link to={`/`} className="text-primary text-2xl font-ultra">
      ...
      <ul class="flex justify-center mt-5 space-x-5">
        ...
        <li>
          <a href="https://github.com/mualimkhair" class="text-primary hover:text-secondary">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fill-rule="evenodd"
        ...
        <li>
          <a href="https://www.instagram.com/mualim_laode/" class="text-primary hover:text-secondary">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fill-rule="evenodd"
